...
<ul class="grid grid-cols-3 grid-rows-1 gap-12 md:w-full md:grid-cols-2 md:gap-x-14 sm:grid-cols-2">
        ...
        <li>
            <div class="group relative align-center rounded-2xl overflow-hidden h-5/6">
                ...
                <figure class="rounded-2xl img-holder overflow-hidden">
                    <img src={decor} class="w-full h-80 transition delay-150 duration-700 ease-in-out focus:scale-110 hover:scale-110 focus:brightness-50 hover:brightness-50" loading="lazy" alt="3d Didita Art" />
                </figure>
